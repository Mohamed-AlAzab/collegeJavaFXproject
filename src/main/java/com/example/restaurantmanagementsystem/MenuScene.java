...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        table.getColumns().addAll(idCol, nameCol, priceCol, descCol);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        AddBtn.setStyle("-fx-background-color: blue; -fx-text-fill: white;");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        AddBtn.setOnAction(e -> {
            ...
            try {
                ...
                pst.setDouble(3, Double.parseDouble(tPrice.getText()));
                pst.setString(4, tDesc.getText());
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        DeleteBtn.setOnAction(e -> {
            ...
            try {
                pst = conn.prepareStatement(sql);
                pst.setInt(1, Integer.parseInt(tidd.getText()));
